...
#define GPIO_GSMPWR		(GPIO_NUM_17)
...
static GSM_Cmd cmd_CBC =   //电池电量查询
{
	.cmd = "AT+CBC\r\n",
	.cmdSize = sizeof("AT+CBC\r\n")-1,
	.cmdResponseOnOk = GSM_OK_Str,
	.timeoutMs = 300,
	.delayMs = 0,
	.skip = 0,
...
#define GPIO_GSM_PWR	19

void IIC_GSM_GPIO_Init(void)
{
    gpio_config_t io_conf;
    io_conf.intr_type = GPIO_PIN_INTR_DISABLE;
    io_conf.mode = GPIO_MODE_OUTPUT;
    io_conf.pin_bit_mask = (1 <<GPIO_GSM_PWR);
...
{
    gpio_set_level(GPIO_GSM_PWR, 1);
}

void GSM_PWR_Off(void)
{
    gpio_set_level(GPIO_GSM_PWR, 0);
}
